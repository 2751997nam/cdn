...
router.get('/images/:resolution(\\d+x\\d+)/:quality(\\d+)?/:url(*(.png|.jpeg|.jpg|.webp))', ResizeImageController.resize.bind(ResizeImageController));
router.get('/images/:resolution(\\d+x\\d+)/:quality(\\d+)?/:url(*)', ResizeImageController.redirectUnsuportImage.bind(ResizeImageController));
